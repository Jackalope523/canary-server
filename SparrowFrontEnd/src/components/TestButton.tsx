...
export const TestButton: React.FC<ButtonProps> = ({
  ...
  switch (size) {
    case ButtonSize.ExtraSmall : 
      btnStyle = [...btnStyle, buttonStyles.textButtonExtraSmall, Gap.gapMedium];
      btnTextStyle = [...btnTextStyle, globalStyles.buttonTextThree];
      btnActiveStyle = [...btnActiveStyle, buttonStyles.textButtonExtraSmall, Gap.gapMedium];
      btnActiveTextStyle = [...btnActiveTextStyle, globalStyles.buttonTextThree];
    break;

    case ButtonSize.Small : 
      btnStyle = [...btnStyle, buttonStyles.textButtonSmall, Gap.gapMedium];
      btnTextStyle = [...btnTextStyle, globalStyles.buttonTextTwo];
      btnActiveStyle = [...btnActiveStyle, buttonStyles.textButtonSmall, Gap.gapMedium];
    ...
    case ButtonSize.Medium : 
      ...
      btnActiveStyle = [...btnActiveStyle, buttonStyles.textButtonMedium, Gap.gapMedium];
    ...
    case ButtonSize.Large : 
      ...
      btnTextStyle = [...btnTextStyle, globalStyles.buttonTextOne];
      btnActiveStyle = [...btnActiveStyle, buttonStyles.textButtonLarge, Gap.gapMedium];
      btnActiveTextStyle = [...btnActiveTextStyle, globalStyles.buttonTextOne];
    break;
  }
