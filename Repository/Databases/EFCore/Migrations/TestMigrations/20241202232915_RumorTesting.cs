...
{
    /// <inheritdoc />
    public partial class RumorTesting : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RumoredGatherings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    InvestigatorId = table.Column<long>(type: "INTEGER", nullable: false),
                    RumoredGatheringId = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Investigations_RumoredGatherings_RumoredGatheringId",
                        column: x => x.RumoredGatheringId,
                        principalTable: "RumoredGatherings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rumors_RumoredGatherings_RumoredGatheringId",
                        column: x => x.RumoredGatheringId,
                        principalTable: "RumoredGatherings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rumors_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<long>(type: "INTEGER", nullable: true),
                    RumorId = table.Column<long>(type: "INTEGER", nullable: false),
                    FilingDate = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    Type = table.Column<int>(type: "INTEGER", nullable: false),
                    SoftDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RumorReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RumorReports_Rumors_RumorId",
                        column: x => x.RumorId,
                        principalTable: "Rumors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RumorReports_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Investigations_InvestigatorId_RumoredGatheringId",
                table: "Investigations",
                columns: new[] { "InvestigatorId", "RumoredGatheringId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Investigations_RumoredGatheringId",
                table: "Investigations",
                column: "RumoredGatheringId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RumorReports_RumorId",
                table: "RumorReports",
                column: "RumorId");

            migrationBuilder.CreateIndex(
                name: "IX_RumorReports_UserId",
                table: "RumorReports",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Rumors_AuthorId",
                table: "Rumors",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_Rumors_RumoredGatheringId",
                table: "Rumors",
                column: "RumoredGatheringId");
